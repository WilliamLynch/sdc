...
class Sigmoid(Layer):
    ...
    def backward(self):
        ...
        for n in self.outbound_layers:
            ...
            The backward method sums the derivative 
            (it's a normal derivative when there's only one variable)
            with respect to the only input over all the output layers. 
            
            The last line implements the derivative
