...
def sgd_update(trainables, learning_rate=1e-2):
    ...
    for t in trainables:
        ...
        # trainable.
        # The partial of the cost (C) with respect to the trainable t is accessed.
        partial_d = t.gradients[t]
        # the value of the trainable is updated 
        t.value -= learning_rate * partial_d
